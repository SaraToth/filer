...
const { getLandingPage, getDashboard, getDashboardFolder } = require("../controllers/indexController");
...
indexRouter.get("/dashboard/folder/:folderId", isAuthorized, getDashboardFolder)
