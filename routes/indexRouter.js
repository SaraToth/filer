...
const { getLandingPage, getDashboard, getDashboardFolder, getFolders, getFiles } = require("../controllers/indexController");
...
indexRouter.get("/dashboard/folder/:folderId", isAuthorized, getFolders, getFiles, getDashboardFolder)
